...
description: >
  ...
  the DevOps department is not yet active.
---

## Estado

⚠️ Este agente forma parte del departamento de DevOps, que aún no está implementado.
...
2. Informa al usuario de que el departamento de DevOps aún no está activo.
3. Sugiere registrar la petición en `.context/<proyecto>/devops/tasks.md` (sección "📋 Pendiente — para futura implementación") con la fecha de la solicitud.
