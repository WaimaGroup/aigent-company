...
3. **Invocar `b64.cjs decode`** desde la raíz del repo (donde vive `.context/`):
   ...
   ```bash
   node .aigent/departments/_shared/skills/shared-base64/b64.cjs decode \
...
1. **Invocar `b64.cjs encode`** desde la raíz del repo:
   ...
   ```bash
   node .aigent/departments/_shared/skills/shared-base64/b64.cjs encode \
...
```
node .aigent/departments/_shared/skills/shared-base64/b64.cjs <command> [opciones]
